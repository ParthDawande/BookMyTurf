...
export const getPublicTurfDetail = (id) => client.get(`/api/public/turfs/${id}`);
export const getPublicAvailability = (id, date) =>
  client.get(`/api/public/turfs/${id}/availability`, { params: { date } });
